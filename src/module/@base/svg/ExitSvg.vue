...
<template>
  <svg width="173px" height="173px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <g id="SVGRepo_iconCarrier">
      <g id="Interface / Exit">
        <path id="Vector"
              ...
              stroke="#ffffff" stroke-width="1.8960000000000001" stroke-linecap="round" stroke-linejoin="round"></path>
      </g>
    </g>
  </svg>
</template>
